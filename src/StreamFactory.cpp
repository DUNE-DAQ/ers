 ...
 */
ers::InputStream*
ers::StreamFactory::create_in_stream(const std::string& stream, const std::string& param) const
{
 ...
 */
ers::InputStream*
ers::StreamFactory::create_in_stream(const std::string& stream, const std::initializer_list<std::string>& params) const
{
