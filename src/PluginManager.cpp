...
const char* const DefaultLibraryName =
  "ers_AbortStream_ersStream:ers_ExitStream_ersStream:ers_FilterStream_ersStream:ers_GlobalLockStream_ersStream:ers_"
  "LockStream_ersStream:ers_NullStream_ersStream:ers_RFilterStream_ersStream:ers_StandardStream_ersStream:ers_"
  "ThrottleStream_ersStream:ers_ThrowStream_ersStream";
