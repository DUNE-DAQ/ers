...
public:
  ...
  int debug_level() const /**< \brief returns current debug level */ { return m_debug_level; }

  int verbosity_level() const /**< \brief returns current verbosity level */ { return m_verbosity_level; }
...
std::ostream&
operator<<(std::ostream&, const ers::Configuration&);
}
